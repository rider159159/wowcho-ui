...
<template>
  <div>
    <div class="relative">
      ...
      <div class="absolute left-4 bottom-4 bg-brand-2 font-medium text-white rounded-lg px-3 py-2">剩餘 {{ count }} 份</div>
    </div>
    ...
    <p class="text-sm md:text-base text-gray-2 mb-3 md:mb-4">
    ...
    <ul class="text-gray-1">
      ...
      <li class="border-t-1 border-gray-4 pt-3 md:pt-4 mb-3 md:mb-4">
        ...
        <p class="font-medium md:text-xl">{{ props.content }}</p>
      </li>
    </ul>
