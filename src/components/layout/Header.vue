          ...
          <ul
            ...
            <li v-if="isLogin" class="cursor-pointer relative" data-te-nav-item-ref>
              <svg @click="showMemberMenu = !showMemberMenu" @blur="closeMemberMenu" width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.5" y="0.5" width="47" height="47" rx="23.5" fill="#ECF7FF"/>
        ...
        <div>
          ...
          <ul>
            ...
            <li v-if="isLogin" data-te-nav-item-ref class="mb-8">
              <a
                class="block transition duration-150 ease-in-out hover:text-neutral-700 focus:text-neutral-700 disabled:text-black/30 dark:hover:text-white dark:focus:text-white lg:p-2 lg:pb-5 [&.active]:text-black/90 border-b-1 border-line"
                href="#!"
                >會員專區</a
              >
              <ul class="mt-3 ml-4">
